...
def load_chemical_interaction_and_seperate_information():
    url_file = 'https://downloads.thebiogrid.org/Download/BioGRID/Release-Archive/BIOGRID-4.4.229/BIOGRID-CHEMICALS-4.4.229.chemtab.zip'
...
def load_protein_interaction_and_seperate_information():
    ...
    :return:
    """
    url_file = 'https://downloads.thebiogrid.org/Download/BioGRID/Release-Archive/BIOGRID-4.4.229/BIOGRID-ORGANISM-4.4.229.tab3.zip'
    ...
    with ZipFile(BytesIO(request.content), 'r') as zipObj:
        ...
        file_name = 'BIOGRID-ORGANISM-Homo_sapiens-4.4.229.tab3.txt'
