...
def load_chemical_interaction_and_seperate_information():
    url_file = 'https://downloads.thebiogrid.org/Download/BioGRID/Release-Archive/BIOGRID-4.4.220/BIOGRID-CHEMICALS-4.4.220.chemtab.zip'
...
def load_protein_interaction_and_seperate_information():
    ...
    :return:
    """
    url_file = 'https://downloads.thebiogrid.org/Download/BioGRID/Release-Archive/BIOGRID-4.4.220/BIOGRID-ORGANISM-4.4.220.tab3.zip'
    ...
    request = get(url_file)
    with ZipFile(BytesIO(request.content), 'r') as zipObj:
        file_name = 'BIOGRID-ORGANISM-Homo_sapiens-4.4.220.tab3.txt'
