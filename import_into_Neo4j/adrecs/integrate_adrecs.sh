...
java -jar ../$import_tool.jar -i sources/ADReCS/intermediate.graphml.gz  -e bolt://localhost:$neo4j_bolt --username neo4j --password $password --label-prefix ADReCS_ --indices "ADReCS_Drug.id;ADReCS_ADR.id" > output/import_tool_output.txt
