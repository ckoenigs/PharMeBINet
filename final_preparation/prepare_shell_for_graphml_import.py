...
path_to_pharmebinet=$2\n\n''')
    ...
    import_tool = f'java -jar $import_tool.jar -i $path_to_pharmebinet"PharMeBiNet_finished.graphml"  -e bolt://localhost:{neo4j_bolt} --username neo4j --password test1234  --modify-edge-labels false --indices "%s"'
