#!/bin/bash
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:3999 MONDO:0002829 Disease
now=$(date +"%F %T")
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:5517 MONDO:0004950 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:2348 MONDO:0002277 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0060499 MONDO:0000774 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0050955 MONDO:0008458 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:5859 MONDO:0003680 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0080253 MONDO:0033044 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0080008 MONDO:0005380 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
