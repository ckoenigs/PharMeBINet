#!/bin/bash
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:60003 MONDO:0002829 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:8256 MONDO:0002722 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:2776 MONDO:0002422 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0111042 MONDO:0010598 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0040087 MONDO:0000774 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0060773 MONDO:0009151 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0070141 MONDO:0009054 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0080335 MONDO:0014175 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0050144 MONDO:0016575 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:6175 MONDO:0004398 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0050671 MONDO:0004379 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:2702 MONDO:0006906 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:4839 MONDO:0006962 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0050665 MONDO:0016011 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0070313 MONDO:0006676 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:3122 MONDO:0001561 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0060025 MONDO:0001341 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:5363 MONDO:0013280 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:5917 MONDO:0003704 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:12965 MONDO:0003730 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0080304 MONDO:0027772 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:0050549 MONDO:0013127 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:5744 MONDO:0005211 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:1852 MONDO:0019072 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:6620 MONDO:0010626 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
...
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:461 MONDO:0003061 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
python ../add_information_from_a_not_existing_node_to_existing_node.py DOID:5672 MONDO:0005575 Disease
now=$(date +"%F %T")
                    echo "Current time: $now"
