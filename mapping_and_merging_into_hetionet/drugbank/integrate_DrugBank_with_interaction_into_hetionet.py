...
# old_properties
old_properties=["allfields","salt_names","molecular_formula","unii","salt_uniis","salt_inchikeys","cas_number","synonyms","brands","type","xrefs","alternative_ids","inchikey","atc_codes","alternative_drugbank_ids","food_interaction","drugbank","categories","ctd","ctd_url","aeolus","rxnorm_cuis","pubChem_id","sider","ndf_rt","resource","license","inchi","groups","source","url","hetionet","identifier","name","merged_identifier","sequences","url_ctd","pubChem","licenses","no_further_chemical_information"]
