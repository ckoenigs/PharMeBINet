...
def generate_files(path_of_directory):
    ...
    query = '''Using Periodic Commit 10000 Load CSV  WITH HEADERS From "file:%smapping_and_merging_into_hetionet/drugbank/compound_variant/%s.tsv" As line FIELDTERMINATOR '\\t' 
