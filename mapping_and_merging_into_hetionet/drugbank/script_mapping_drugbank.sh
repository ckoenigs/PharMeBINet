...
python integrate_DrugBank_with_interaction_into_hetionet.py $license $path_to_project > output_integration_file_generation.txt
...
python salt_to_compound_mapping_connection_to_drugs.py $license $path_to_project > output_integration_file_generation_salt.txt
