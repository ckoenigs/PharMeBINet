...
def load_pharmebinet_go_in():
    ...
    get_information_and_add_to_dict('BiologicalProcess',dict_biological_process_pharmebinet, dict_biological_process_alternative_pharmebinet)

    # fill dict for molecular function
    get_information_and_add_to_dict('MolecularFunction',dict_molecular_function_pharmebinet, dict_molecular_function_alternative_pharmebinet)

    # fill dict for cellular components
    get_information_and_add_to_dict('CellularComponent',dict_cellular_component_pharmebinet, dict_cellular_component_alternative_pharmebinet)
...
def check_if_new_or_part_of_pharmebinet(pharmebinet_label, go_id, go_name,highestGOLevel):
    ...
    [dict_pharmebinet, dict_alternative_id_to_pharmebinet, dict_ctd_in_pharmebinet_alternative, dict_ctd_in_pharmebinet] = dict_process[pharmebinet_label]
...
dict_process = {
    "Biological Process": [dict_biological_process_pharmebinet, dict_biological_process_alternative_pharmebinet, dict_ctd_biological_process_in_pharmebinet_alternative,
                           dict_ctd_biological_process_in_pharmebinet],
    "Molecular Function": [dict_molecular_function_pharmebinet, dict_molecular_function_alternative_pharmebinet, dict_ctd_molecular_function_in_pharmebinet_alternative,
                           dict_ctd_molecular_function_in_pharmebinet],
    "Cellular Component": [dict_cellular_component_pharmebinet,dict_cellular_component_alternative_pharmebinet, dict_ctd_cellular_component_in_pharmebinet_alternative,
                           dict_ctd_cellular_component_in_pharmebinet]
}
...
def generate_files(file_name_addition, ontology, dict_ctd_in_pharmebinet,dict_ctd_in_pharmebinet_alternative ):
    ...
    query='''Using Periodic Commit 10000 Load CSV  WITH HEADERS From "file:'''+path_of_directory+'''mapping_and_merging_into_hetionet/ctd/GO/mapping_%s.tsv" As line  FIELDTERMINATOR '\\t' Match (c:%s{ identifier:line.GOIDpharmebinet}), (n:CTD_GO{go_id:line.GOIDCTD}) SET  c.url_ctd=" http://ctdbase.org/detail.go?type=go&acc="+line.GOIDCTD, c.highestGOLevel=n.highestGOLevel, c.ctd="yes", c.resource=split(line.resource,"|") Create (c)-[:equal_to_CTD_go]->(n);\n'''
