...
path = "pathways_hetionet_data/PathwayCommons9.All.hgnc_change.gmt"
# version for pc7
...
gmt_generator = read_gmt('pathways_hetionet_data/wikipathways.gmt')
...
print(pathway_df)
pathway_df = pathway_df[['identifier', 'name', 'url', 'source', 'license', 'genes','idOwn','ownIDSource']]
...
write_df.to_csv('pathways_hetionet_data/pathways_v9.tsv', index=False, sep='\t',encoding='utf-8')