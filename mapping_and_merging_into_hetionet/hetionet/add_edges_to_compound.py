...
def main():
    ...
    list_of_combinations = [
        ['Compound', 'Compound_hetionet', 'Gene_hetionet', 'Gene', 'BINDS_CbG', 'BINDS_CHbG'],
        ['Compound', 'Compound_hetionet', 'Gene_hetionet', 'Gene', 'DOWNREGULATES_CdG', 'DOWNREGULATES_CHdG'],
        ['Compound', 'Compound_hetionet', 'Gene_hetionet', 'Gene', 'UPREGULATES_CuG', 'UPREGULATES_CHuG'],
        ['Compound', 'Compound_hetionet', 'Disease_hetionet', 'Disease', 'TREATS_CtD', 'TREATS_CHtD'],
        ['Compound', 'Compound_hetionet', 'Disease_hetionet', 'Disease', 'PALLIATES_CpD', 'PALLIATES_CHpD']

    ]

    directory = 'edges'
    cypher_file = open('output/cypher_edge_2.cypher', 'w', encoding="utf-8")
