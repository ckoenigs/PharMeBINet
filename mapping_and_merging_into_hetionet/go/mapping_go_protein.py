...
def load_all_protein_form_go_and_map_and_write_to_file(csv_writer, csv_not_mapped):
...
def main():
    ...
    csv_writer, csv_not_mapped=generate_files(path_of_directory,'Protein')
    ...
    load_all_protein_form_go_and_map_and_write_to_file(csv_writer, csv_not_mapped)
