...
def get_FO_properties():
    ...
    query_new = query_nodes_start + query_middle_new + 'resource:["FoodOn"], foodon:true, source:"FoodOn", url:"https://www.ebi.ac.uk/ols4/ontologies/foodon/classes?obo_id="+line.identifier, licenses:["' + license + '"]})' + query_end
    return query_new
...
def get_is_a_relationships_and_add_to_tsv(cypher_file):
    ...
    for record in results:
        ...
        if rela_type not in dict_type_to_tsv:
            ...
            query = '''Match (a1:%s{identifier:line.identifier_1}), (a2:%s{identifier:line.identifier_2}) Create (a1)-[:%s{licenses:["%s"], source:"FoodOn", unbiased:false, resource:["FoodOn"], foodon:true, url:"https://www.ebi.ac.uk/ols4/ontologies/foodon/classes?obo_id="+line.identifier_1}]->(a2)'''
