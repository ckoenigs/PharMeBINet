...
def load_pair_edges(label):
    ...
    for record in results:
        ...
        if (node_id_1, node_id_2) not in dict_of_used_pairs:
            ...
            print('double')
            dict_of_used_pairs[(node_id_1, node_id_2)][0] = dict_of_used_pairs[(node_id_1, node_id_2)][0].union(
                pubmed_ids)
            dict_of_used_pairs[(node_id_1, node_id_2)][1] = dict_of_used_pairs[(node_id_1, node_id_2)][1].union(urls)
            dict_of_used_pairs[(node_id_1, node_id_2)][2] = dict_of_used_pairs[(node_id_1, node_id_2)][2].union(
                references_set)
    ...
    for (disease_id, metabolite_id), pubmed_ids_urls in dict_of_used_pairs.items():
        csv_writer.writerow([disease_id, metabolite_id, '|'.join(pubmed_ids_urls[0]), '|'.join(pubmed_ids_urls[1]),
                             '|'.join(pubmed_ids_urls[2])])
