...
create = " Create (SideEffect:SideEffect :Phenotype {identifier: line.identifier, name: line.name, resource: split(line.resource,'|'), source:'UMLS via openFDA', openfda:true, url:'http://identifiers.org/umls/'+line.identifier})"
