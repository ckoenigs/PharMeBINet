...
def load_hetionet_failedreaction_hetionet_node_in(csv_file, dict_failedReaction_hetionet_node_hetionet,
    ...
    query = '''MATCH (p:FailedReaction)-[:equal_to_reactome_failedreaction]-(r:FailedReaction_reactome)-[v:%s]->(n:%s)-[]-(b:%s) RETURN p.identifier, b.identifier, v.order, v.stoichiometry'''
