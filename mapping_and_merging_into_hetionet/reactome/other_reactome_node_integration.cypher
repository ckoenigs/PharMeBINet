...
CREATE (m:Reaction{identifier:n.stId, synonyms:apoc.convert.fromJsonList(n.name), node_edge:true, name:n.displayName, alternativeId:n.oldStId, isInDisease:n.isInDisease, isChimeric:n.isChimeric,
...
CREATE (m:Polymerisation{identifier:n.stId, synonyms:apoc.convert.fromJsonList(n.name), node_edge:true, name:n.displayName, alternativeId:n.oldStId, isInDisease:n.isInDisease, isChimeric:n.isChimeric,
...
CREATE (m:Depolymerisation{identifier:n.stId, synonyms:apoc.convert.fromJsonList(n.name), node_edge:true, name:n.displayName, alternativeId:n.oldStId, isInDisease:n.isInDisease, isChimeric:n.isChimeric,
...
CREATE (m:BlackBoxEvent{identifier:n.stId, synonyms:apoc.convert.fromJsonList(n.name), node_edge:true, name:n.displayName, alternativeId:n.oldStId, isInDisease:n.isInDisease, isChimeric:n.isChimeric,
...
CREATE (m:FailedReaction{identifier:n.stId, synonyms:apoc.convert.fromJsonList(n.name), node_edge:true, name:n.displayName, alternativeId:n.oldStId, isInDisease:n.isInDisease, isChimeric:n.isChimeric,
...
//CREATE (m:Regulation{identifier:n.dbId, name:n.displayName, alternativeId:n.oldStId, pubMed_ids:n.pubMed_ids,
