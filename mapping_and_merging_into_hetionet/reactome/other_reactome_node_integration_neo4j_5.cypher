...
category:n.category, isInferred:n.isInferred, definition:n.definition, resource:['Reactome'], licenses:['CC BY-SA 4.0'],  reactome:true, url:"https://reactome.org/content/detail/"+ n.stId, pubMed_ids:n.pubMed_ids, source:"Reactome", systematicName:n.systematicName})<-[:equal_to_reactome_reaction]-(n);
...
category:n.category, isInferred:n.isInferred, definition:n.definition, resource:['Reactome'], licenses:['CC BY-SA 4.0'],  reactome:true, url:"https://reactome.org/content/detail/"+ n.stId, pubMed_ids:n.pubMed_ids, source:"Reactome", systematicName:n.systematicName})<-[:equal_to_reactome_polymerisation]-(n);
...
category:n.category, isInferred:n.isInferred, definition:n.definition, resource:['Reactome'], licenses:['CC BY-SA 4.0'],  reactome:true, url:"https://reactome.org/content/detail/"+ n.stId, pubMed_ids:n.pubMed_ids, source:"Reactome"})<-[:equal_to_reactome_depolymerisation]-(n);
...
category:n.category, isInferred:n.isInferred, definition:n.definition, resource:['Reactome'], licenses:['CC BY-SA 4.0'],  reactome:true, url:"https://reactome.org/content/detail/"+ n.stId, pubMed_ids:n.pubMed_ids, source:"Reactome", systematicName:n.systematicName})<-[:equal_to_reactome_blackBoxEvent]-(n);
...
category:n.category, isInferred:n.isInferred, definition:n.definition, resource:['Reactome'], licenses:['CC BY-SA 4.0'],  reactome:true, url:"https://reactome.org/content/detail/"+ n.stId, pubMed_ids:n.pubMed_ids, source:"Reactome", systematicName:n.systematicName})<-[:equal_to_reactome_failedreaction]-(n);
...
url:"https://reactome.org/content/detail/" + n.stId, source:'Reactome', resource:['Reactome'], reactome:true, licenses:['CC BY-SA 4.0'], url:'https://reactome.org/'})<-[:equal_to_reactome_regulation]-(n);
...
url:"https://reactome.org/content/detail/" + n.stId, source:'Reactome', resource:['Reactome'], reactome:true, licenses:['CC BY-SA 4.0']})<-[:equal_to_reactome_complex]-(n);
