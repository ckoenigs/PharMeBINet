...
def generate_cypher_file():
    ...
    query_new = ' Match (b:se_Sider{umlsIDmeddra:line.identifier}) Create (n:SideEffect :Phenotype{' + query_new + ' sider:true, url:"http://identifiers.org/umls/"+line.identifier, resource:["SIDER"],  source: "UMLS via SIDER 4.1", licenses:["'+pharmebinetutils.dict_source_to_license["sider"]+'"]}) Create (n)-[:equal_to_SE]->(b)'
