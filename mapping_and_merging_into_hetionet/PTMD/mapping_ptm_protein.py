...
def get_PTMD_information(edge_type):
    ...
    if edge_type == 'PTMD_HAS_PTM':
        ...
        query = (f' Match (p:PTM{{identifier:line.ptm_id}}), (d:Protein{{identifier:line.protein_id}}) '
             f'Create (p)-[:PTMD_INVOLVES{{resource:["PTMD"],ptmd:"yes", url:"https://ptmd.biocuckoo.cn/index.php",  source:"PTMD", license:"ONLY freely available for academic research"}}]->(d)')
